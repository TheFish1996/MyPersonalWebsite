    ...
    return (
        <Row>
            ...
            <Col style={{paddingRight: "200px", textAlign: "left", marginTop: "450px"}} xl="4">
                <p style={{lineHeight: "30px"}}><span style={{fontSize: "60px"}}>A</span>t Stevens, my main projects were either web development or mobile app development. 
            ...
            <Col style={{paddingRight: "200px", textAlign: "left", marginBottom: "350px"}} xl="4">
                <p style={{lineHeight: "30px"}}><span style={{fontSize: "60px"}}>H</span>ello, my name is Jonathan Fishkin and I was born and raised in Staten Island New York. My parents originally come from Israel and Russia.
            ...
            <Col style={{paddingRight: "70px", textAlign: "left", marginTop: "450px", paddingLeft: "150px"}} xl="4">
                <p style={{lineHeight: "30px"}}><span style={{fontSize: "60px"}}>I</span>code in JavaScript, Node.js, C#, Java, HTML/CSS, React.js, .NET, and SQL
                I am familiar with cloud services pertaining to Amazon Web Services and Google Cloud Platform.
                A full list of my technical skills is available on my LinkedIN as well as my resume. Which can be found on either the contact page or the navigation page  
                </p>
            </Col>
        </Row>
    )
